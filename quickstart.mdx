...
<Note>Detect the exact moment a change starts at the micro-level before it is visible in macro data.</Note>

### Phase 2: Mapping Multiscale Signal Propagation

<Note>Follow the signal as it scales upward, evolving from a minor fluctuation into a significant trend.</Note>

### Phase 3: Causal Chain Completion

<Note>Identify the end point of the sequence, marking the end of the directional move.</Note>
