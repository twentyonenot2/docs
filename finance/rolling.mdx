...
| `reasoning_mode` | `string` | `True`   | The reasoning strategy our algorithms use to make decisions: 'proactive' acts early with minimal information while 'reactive' waits for sufficient evidence before acting.                            |
