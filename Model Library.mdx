...
<CardGroup cols={1}>
  ...
  >
    > Desc: A pre-trained time series model that fairly weights both short-term and long-term directional volatility.
    >
    > Status: In Production
    >
    > URL: https://www.sumtyme.ai/api/genesis 
  </Card>
  <Card
    title="Genesis-STC"
    sub
  ...
  >
    ...
    > Status: In Production
    >
    > URL: https://www.sumtyme.ai/api/genesis-stc 
  </Card>
   <Card
    title="Genesis-M"
  ...
  >
    ...
    >
    > URL: https://www.sumtyme.ai/api/TBC  
  </Card>
   <Card
    title="Genesis-STC-M"
    icon="lightbulb" iconType="duotone" color="#ffa500"
