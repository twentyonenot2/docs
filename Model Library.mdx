...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="lightbulb" iconType="duotone" color="#8fbc8f"
  >
    A pre-trained time series model designed to be more sensitive to short-term price directional volatility.
  </Card>
   <Card
    title="Genesis-M"
...
<AccordionGroup>
  <Accordion title="Genesis" icon="lightbulb" iconType="duotone" color="#8fbc8f">
    > Endpoint URL - https://www.sumtyme.ai/api/genesis
    >
    > A pre-trained time series model that fairly weights both short-term and long-term directional volatility.
  </Accordion>

  <Accordion title="Genesis-STC" icon="lightbulb" iconType="duotone" color="#8fbc8f">
    > Endpoint URL - https://www.sumtyme.ai/api/genesis-stc
    >
    > A pre-trained time series model designed to be more sensitive to short-term price directional volatility.
  </Accordion>

  <Accordion title="Genesis-M" icon="lightbulb" iconType="duotone" color="#ffa500">
    > Endpoint url - https://www.sumtyme.ai/api/genesis-stc
    >
    > This stateful version of Genesis will remember and maintain its internal state from the previous forecast.
  </Accordion>

  <Accordion title="Genesis-STC-M" icon="lightbulb" iconType="duotone" color="#ffa500">
    > Endpoint url - https://www.sumtyme.ai/api/genesis-stc
    >
    > This stateful version of Genesis-STC will remember and maintain its internal state from the previous forecast.
  </Accordion>
...
| Endpoint   | Production  | 
| ----------- | ------------------------ | 
| **https://www.sumtyme.ai/api/genesis** | `<sup>PROD</sup>` | 
| **https://www.sumtyme.ai/api/genesis-stc**   | `<sub>PROD</sub>`   |
