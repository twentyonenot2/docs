...
We've built a time series foundation model purpose-built for financial markets that generalises across any time interval, market or asset class without requiring pre-training, eliminating the need to build market-specific models from scratch.
