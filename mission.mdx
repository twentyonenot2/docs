...
Our time series foundation model uses a neuro-symbolic architecture trained entirely on synthetic data, enabling it to capture market dynamics without relying on historical patterns.
