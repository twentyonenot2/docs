...
<AccordionGroup>
  <Accordion title="Understanding Forecast">
  ...
  <Accordion title="Unified System Architecture">
  ...
  <Accordion title="Processing Queue">
  ...
  <Accordion title="Model Assumption">
