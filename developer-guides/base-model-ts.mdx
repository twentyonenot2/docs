...
description: "This model identifies directional trends by analysing price action within the selected timeframe in isolation, responding quickly to timeframe specific movements and generating frequent trend signals without broader context."
slug: "/dev-guide/base-model-ts"
---
