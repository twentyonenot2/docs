...
## Price Data Download Example

<AccordionGroup>
  <Accordion title="Download AAPL Daily Price Data from Yahoo Finance">
    ```python
  ...
  <Accordion title="Download BTCUSDT 1 Second Data from Binance">
    ```python
