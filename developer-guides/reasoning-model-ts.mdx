...
slug: "/dev-guide/reasoning-model"
---
...
# Verify data length requirements (5000-10,000 periods)
data_length = len(df)
if data_length < 5000:
    raise ValueError(f"Data length ({data_length}) is less than minimum required (5000)")
