...
| :------- | :---- | :-------------------------------------------------------------------------------------------- |
| `1`      | `int` | Positive chain detected.                                                                      |
| `0`      | `int` | No chain detected on current timeframe, early-stage formation detected on higher frequencies. |
| `-1`     | `int` | Negative chain detected.                                                                      |
...
**Example Data Format for Financial Time Series**
...
chain_detected values: 1 (positive chain), -1 (negative chain), 0 (no chain detected on current timeframe, early stage formation detected on higher frequencies.)
"""
```