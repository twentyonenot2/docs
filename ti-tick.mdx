---
title: "Trade Identifier - Tick Data"
slug: '/ti-tick'
---

## Model Overview

This API leverages advanced mathematical modelling to analyse high-frequency tick data, identifying potential trading opportunities through abstract reasoning.
...
```python
{
    'Datetime': ["2025-01-01 09:32:00.352", "2025-01-01 09:32:00:478",..., "2025-01-02 11:28:00.000"],
    'Open': [194.33, 195.19, ..., 0],         # Unknown future value
    'High': [194.33, 195.19, ..., 0],         # Unknown future value
    'Low': [194.33, 195.19, ..., 0],          # Unknown future value
    'Close': [195.33, 195.19, ..., 0]         # Unknown future value
}
```
...
api_url = f"{BASE_URL}/auth/ti-tld"
