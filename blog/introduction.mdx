...
description: "An AI Learning Framework for Modelling Cause and Effect in System Behaviour"
slug: "/blog/ai-learning-framework"
---

**tl;dr** _We've created a universal mathematical framework to model the non-linear evolution of any complex system time series that enables the creation of autonomous, instantly deployable AI models, eliminating the need for all training and continual maintenance_
