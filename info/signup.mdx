...
2. **Manual Sign-up**: Alternatively, you can use [this form](https://tally.so/r/wAMyky). We will then contact you via email with your API key and setup instructions.
