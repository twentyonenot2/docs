...
**Manual Setup**: Use this function `user_signup`to send your sign-up request. It will immediately return your API key and automatically save it to a local `config.txt` file.
