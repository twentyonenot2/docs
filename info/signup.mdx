...
2. **Manual Sign-up**: Alternatively, you can use [this form](https://tally.so/r/nWvBEQ). We will then contact you via email with your API key and setup instructions.
