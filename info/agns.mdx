---
title: "Abstract Generalised Networks (AGNs)"
---

**What are AGNs?**

AGNs are a proprietary AI architecture that functions as a world model. They provide AI systems with a dynamic internal representation of how a real-world environment evolves over time. This is achieved by modelling how information flows across different time frequencies.
