...
We are introducing a new field of Machine Learning called Causal Intelligence (CI). CI will enable machines to autonomously identify, model, and reason about the underlying causal structure of the world purely from passive observational data.
...
| :----------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [**Finance & Trading**](https://docsend.com/view/4gdgiihtm49ht62n) | Anticipating market-wide shifts (macro) by detecting subtle anomalies in high frequency data (micro), delivering predictive lead time for strategic trading.                             |
