...
| **Climate & Atmospheric Modeling**          | Enhancing the accuracy of long-term weather and climate models (macro) by incorporating causal dynamics derived from high-frequency turbulence or sensor readings (micro).               |
